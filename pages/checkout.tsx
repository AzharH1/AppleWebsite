...
// import Currency from "react-curreny-formatter"
// import Stripe from "stripe"
import Button from "@/components/Button";
import CheckoutProduct from "../components/CheckoutProduct";
import { selectBasketItems, selectBasketTotal } from "@/redux/basketSlice";
// import { fectchPostJSON } from "../utils/api-helpers"
              ...
              <div className="divide-y divide-gray-300">
                <div className="pb-4">
                  <div className="flex justify-between">
                    <p>Subtotal</p>
                    <p>{formatCurrency(basketTotal, "USD", "en-US")}</p>
                  </div>
                  <div className="flex justify-between">
                    <p>Shipping</p>
                    <p>FREE</p>
                ...
                <div className="flex justify-between pt-4 text-xl font-semibold">
                  <h4>Total</h4>
                  <h4>{formatCurrency(basketTotal, "USD", "en-US")}</h4>
                </div>
              </div>
              <div className="spcae-y4 my-14">
                ...
                <div>
                  ...
                  <div className="flex flex-1 flex-col items-center rounded-xl bg-gray-200 p-8 py-12 text-center md:order-2">
                    <h4 className="mb-4 flex flex-col text-xl font-semibold">
                      Pay in full
                      <span>{formatCurrency(basketTotal, "USD", "en-US")}</span>
                    </h4>
                    <Button
                      noIcon
                      // loading={loading}
